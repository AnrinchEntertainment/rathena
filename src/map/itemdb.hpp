...
enum Random_Option_Group {
	...
	// SPACE FOR OTHER RANDOMS JUST IN-CASE
	RDMOPTG_SPACE_1,
	RDMOPTG_SPACE_2,
	RDMOPTG_SPACE_3,
	RDMOPTG_SPACE_4,
	...
	RDMOPTG_DAGGERS_3,
	RDMOPTG_DAGGERS_4,
	RDMOPTG_ONEHANDED_WEAPON_1,
	RDMOPTG_ONEHANDED_WEAPON_2,
	RDMOPTG_ONEHANDED_WEAPON_3,
	RDMOPTG_ONEHANDED_WEAPON_4,
	RDMOPTG_TWOHANDED_WEAPON_1,
	RDMOPTG_TWOHANDED_WEAPON_2,
	RDMOPTG_TWOHANDED_WEAPON_3,
	RDMOPTG_TWOHANDED_WEAPON_4,
...
#define USE_RANDOMOPT_DROP_MEMORY_EFFICENT
...
struct s_random_opt_group {
	uint8 id; // Note: May need to increase size of this if wanting to have many groups.
	struct s_random_opt_group_entry *entries;
#ifndef USE_RANDOMOPT_DROP_MEMORY_EFFICENT
	uint16 total;
#else
	uint32 total; // Increased size of total rate and count to uint32.
	uint32 count;
#endif
};
